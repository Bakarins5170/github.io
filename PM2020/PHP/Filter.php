...
//$filterquery="SELECT * FROM Movies WHERE ProductType='$filter'";
//$filterquery="SELECT * FROM Movies ORDER BY Release_Date";
//$filterquery="SELECT * FROM Movies ORDER BY '$filter'";

if($filter=="Movie_Name"){
    $filterquery="SELECT * FROM Movies ORDER BY Movie_Name";
